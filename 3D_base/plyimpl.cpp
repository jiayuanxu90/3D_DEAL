...
PlyImpl::PlyImpl(QString str, Model * &model) : ModelIntf()
{
    property_cursor = 1;
...
bool PlyImpl::read_file(QString str, Model * &model)
{
    QFile file(str);
...
void PlyImpl::deal_with_head(QTextStream &infile)
{
    while (!infile.atEnd()) {
...
void PlyImpl::deal_with_vertices(QTextStream &infile, Model * &model)
{
...
void PlyImpl::deal_with_faces(QTextStream &infile, Model *&model)
{
