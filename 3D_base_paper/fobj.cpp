...
void FObj::deal_with_v(QTextStream &ts, Model *&model)
{
    GLfloat x = 0.0f,
            y = 0.0f,
            z = 0.0f;
...
void FObj::deal_with_vt(QTextStream &ts, Model *&model)
{
    GLfloat x = 0.0f,
            y = 0.0f;
    ts >> x >> y;
...
void FObj::deal_with_vn(QTextStream &ts, Model *&model)
{
    GLfloat x = 0.0f,
            y = 0.0f,
            z = 0.0f;
...
void FObj::deal_with_f(QTextStream &ts, Model * &model)
{
